...
/**
   ...
   *
   * The library functions are declared in the public file <code>cortex_m0/arm_math.h</code> which is placed in the <code>Include</code> folder.
   * Simply include this file and link the appropriate library in the application and begin calling the library functions. The Library supports single 
   * public header file <code> cortex_m0/arm_math.h</code> for Cortex-M4/M3/M0 with little endian and big endian. Same header file will be used for floating point unit(FPU) variants. 
...
#define __CMSIS_GENERIC              /* disable NVIC and Systick functions */
  ...
  #include "cortex_m0/core_cm4.h"
#elif defined (ARM_MATH_CM3)
  #include "cortex_m0/core_cm3.h"
#elif defined (ARM_MATH_CM0)
  #include "cortex_m0/core_cm0.h"
#else
#include "ARMCM4.h"
